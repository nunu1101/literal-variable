...
public class Application2 {
    public static void main(String[] args) {
        ...
        *  예) 앞에서 사용한 int 자료형은 정수를 4byte만큼을 읽어서 하나의 값으로 취급하겠다는 약속
        ...
        * */
        ...
        snum = 2;
        inum = 4;
        lnum = 8L; // 소문자 l로 써도 되지만 글꼴에 따라 숫자 1과 혼동이 있을 수 있음으로 대문자로 하는것을 권장

        // 실수를 취급하는 자료형에 값 대입
        fnum = 4.0f; // 실수 뒤에 f를 붙여야 한다. 대문자 F도 가능하지만 소문자를 사용하는 것이 일반적
        dnum = 8.0;
        ...
        // 논리를 취급하는 자료형에 값 대입
        isTrue = true;
        isTrue = false; //true 혹은 false 중 한 가지의 값만 사용 가능
