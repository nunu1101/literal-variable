...
public class Application3 {
    public static void main(String[] args) {
         ...
         *  또한, 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그래밍을 하는 첫 단추!
         */
         ...
         *  1-5. 특수 기호는 '_'와 '$'만 사용 가능하다. ( 공백을 사용 할 수 없다. )
         *
...
//        int sh@arp = 20;
        ...
        int dhkdshkfasnjkndkijsawuhqkjbadl;
        
        /* 목차 2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두 번째 단어는 대문자로 시작 */
        int maxAge = 20;
        int minAge = 10;
        
        /* 목차 2-3. 단어와 단어 사이의 연결을 언더스코어(_)로 하지 않는다. */
        String user_name;
        String userName; //camel-case로 작성한 올바른 표기법

        /* 목차 2-4. 한글로 변수명을 짓는 것이 가능하지만, 권장하지 않는다. */
        int 나이; // 가능하지만 권장하지 않음

        /* 목차 2-5. 변수 안에 저장된 값이 어떤 의미를 가지는지 명확하게 표현하도록 한다. */
        String s; // 어떤 의미인지 파악하기 어렵다.
        String name; // 명확한 표기법
